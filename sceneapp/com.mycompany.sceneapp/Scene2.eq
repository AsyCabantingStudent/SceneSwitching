...
{	
	...
	rsc.prepare_image("patrick","patrick",get_scene_width(),get_scene_height());
	sprite1=add_sprite_for_image(SEImage.for_resource("patrick"));
	sprite1.move(0,0);
	...
	text2=add_sprite_for_text("This is Patrick", "myfont");
	text2.move(0,0);
	}
