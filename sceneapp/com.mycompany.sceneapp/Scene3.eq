...
{	SESprite sprite1;
	...
	rsc.prepare_image("puff","puff",get_scene_width(),get_scene_height());
	sprite1=add_sprite_for_image(SEImage.for_resource("puff"));
	sprite1.move(0,0);
	...
	text2=add_sprite_for_text("This is Mrs.Puff", "myfont");
	text2.move(0,0);
